...
<html>
    ...
    <body>
        <header>
            Monitoreo de Signos Vitales de Gestantes
        </header>
        <section class="content-login">
            <div class="row">
                <figure class="content-logo">
                    <img src="img/logo_sistema2.png" alt="Opticenter" width="300px">
                </figure>
        ...
        <footer>
            <div class="f1">Aunspiciado por <span class="gxdstudio">Gabriela G.</span></div>
        </footer>
