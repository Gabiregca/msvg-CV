...
if (isset($_SESSION['isLogin'])) {
    if ($_SESSION['isLogin'] === "si") {
        ...
        <html class="metro">
		    ...
		    <img src="img/logo_sistema3v3.png" class="marca" alt="el logo"> 
                    <span class="marca-span">Monitoreo de Signos Vitales en Gestantes</span>
                </section>
                ...
                <footer>
                    ...
                    <div class="f1"> <span class="sponsor">Gabriela G.</span></div>
                </footer>
